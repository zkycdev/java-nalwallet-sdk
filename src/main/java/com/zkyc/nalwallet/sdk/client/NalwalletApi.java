...
public interface NalwalletApi {
     ...
     * @return 返回信息
     */
    ResultMsg withdraw(String address, BigDecimal amount,  String coinType, String businessId, String memo);
     ...
     * @return 返回信息
     */
    ResultMsg withdraw(String address, BigDecimal amount, String coinType, String businessId, String memo, String callUrl);
    ...
    List<Balance> queryBalance(String coinType, List<String> address);
